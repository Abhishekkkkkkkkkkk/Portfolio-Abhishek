...
const Home = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="container mx-auto px-[4%] lg:px-[5%] min-h-screen flex flex-col lg:flex-row items-center justify-center lg:justify-between gap-8 pt-44 pb-20 lg:py-20">

          {/* ── Left Column ── */}
          <div className="w-full lg:w-[42%] space-y-8 text-left">
          ...
          {/* ── Right Column ── */}
          <div 
            className="w-full lg:w-[58%] flex flex-col sm:flex-row items-center justify-center lg:justify-end gap-5"
            data-aos="fade-left"
            data-aos-delay="400"
          >
            <MemoryGame />
