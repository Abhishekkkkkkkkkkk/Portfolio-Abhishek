...
import EducationTimelineItem from "../../timeline/widgets/EducationTimelineItem";
import ExperienceTimelineItem from "../../timeline/widgets/ExperienceTimelineItem";
    ...
    >
        ...
        <div className="flex flex-col-reverse lg:grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="space-y-8">
            ...
            <p
              ...
              data-aos-delay="100"
            >
              Software Developer with <span className="text-[#22d3ee] font-semibold">3+ years</span> of experience building clean, scalable,
      ...
      >
        ...
        <div className="relative grid grid-cols-2 sm:grid-cols-4 gap-8 divide-y sm:divide-y-0 sm:divide-x divide-white/10">
          ...
          <Counter end={450} suffix="+" label="DSA Problems" />
